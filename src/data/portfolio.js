...
export const skills = ['SPS / PLC', 'AutoCAD', 'Inventor', 'SolidWorks', 'MATLAB/Simulink', 'Python', 'MS Office', 'PMP'];
export const languages = ['German (C1)', 'English (C1)', 'Chinese (native)'];